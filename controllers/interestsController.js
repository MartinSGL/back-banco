...
module.exports = {
    ...
    async index(req,res){
        try{
            const data = await interest.findAll({});  //buscar todos los registros con deletedAt = null
    ...
    async update(req,res){
        try{
            ...
            let idFound = await interest.findOne({where:{id}}) //comprobar si existe el id en la base de datos

...
module.exports = {
    ...
    async index(req,res){
        try{
            let data = await position.findAll({}) //find all the registres with deletedAt = null
    ...
    async update(req,res){
        try{
            ...
            let idFound = await position.findOne({where:{id}}) //prove if the id exists in the database
